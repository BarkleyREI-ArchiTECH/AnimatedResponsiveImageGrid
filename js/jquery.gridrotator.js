...
(function ($, window, undefined) {
  ...
  $.GridRotator.defaults = {
    ...
    // custom caption vars:
    captionId: "",
    captionContainerId: "#ImageWallContainer",
    // custom layout vars:
    useCSSlayout: false,
    layoutImagesNum: 0,
  };
  ...
  $.GridRotator.prototype = {
    ...
    _config: function () {
      ...
      if (this.options.useCSSlayout) {
        this.animTypes = ["slideLeft", "slideRight", "slideTop", "slideBottom"];
      }
      ...
      this.usingCaption = this.options.captionId != "";
      this.$caption = this.usingCaption ? $(this.options.captionId) : null;
      this.$captionContainer = this.usingCaption ? $(this.options.captionContainerId) : null;
    ...
    _layout: function (callback) {
      ...
      if (this.usingCaption) {
        var padRight = this.$captionContainer.cssNumber("padding-right");
        var padBottom = this.$captionContainer.cssNumber("padding-bottom");
        var dubWidth = itemWidth * 2;
        ...
        if (this.$caption.width() < dubWidth) {
          this.$caption.css("width", dubWidth);
        }
        if (this.breakpoint >= 768) {
          ...
          if (this.$caption.height() < itemWidth) {
            this.$caption.css("height", itemWidth);
          }
        }

        // layout caption from bottom-right:
        switch (this.breakpoint) {
          case 480:
          case 768:
            this.$caption.css({
              bottom: itemWidth + padBottom,
              right: padRight,
            });
            break;
    ...
    _setGridDim: function () {
      ...
      if (this.options.useCSSlayout) {
        this.showTotal = this.options.layoutImagesNum;
      }
    },
    ...
    _initEvents: function () {
      ...
      // dispatch init event:
      this.$el.trigger("gridrotator.init");
    },
    _visChange: function () {
